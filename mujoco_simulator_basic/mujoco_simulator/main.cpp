...
//  Copyright (C) 2017 Roboti LLC  ds//
//---------------------------------//
...
mjData* d = 0;
char lastfile[1000] = "";
char model_simulation_file[1000] = "C:\\mujoco\\model\\thormang_v5\\thormang_v5.xml";
char model_mjkey_file[1000] = "C:\\mujoco\\bin\\mjkey.txt";
...
char data_print_title[1000] = "";
char data_print_data[1000] = "";
...
//Button Control
bool Control_F = false;
bool Control_R = false;
bool Control_T = false;
bool Control_init = true;
double run_command_time;
...
void render(GLFWwindow* window)
{
	...
	if (showdata)
	{
		...
		mjr_overlay(mjFONT_NORMAL, mjGRID_TOPRIGHT, smallrect, data_print_title, data_print_data, &con);
	}
...
int main(int argc, const char** argv)
{
	...
	loadmodel(window, model_simulation_file);
